...
function (a) {
    ...
    h.prototype.init = function () {
            ...
            b <= this.options.collapseScreenSize && (c = a("body").hasClass(f.open)), c ? this.close()  : this.open()/*077*/
        }, h.prototype.open = function () {
            localStorage.setItem("side", "open");
            ...
            localStorage.setItem("side", "close");
        ...
        a.fn.pushMenu = b, a.fn.pushMenu.Constructor = h, a.fn.pushMenu.noConflict = function () {
            ...
            /*if (hasClass(document.getElementsByTagName("BODY")[0], "test")) { alert("click to save") } */
...
function b(b) {
    ...
    var c = "lte.tree", d = {animationSpeed: 250, accordion: !0, followLink: !1, trigger: ".treeview a"}, e = {
            tree: ".tree",
            treeview: ".treeview",
    ...
    h.prototype.toggle = function (a, b) {
        ...
        a(this.element).on("click", this.options.trigger, function (c) {
            ...
            localStorage.setItem(P.id, P.className)
        })
    };
    var i = a.fn.tree;
